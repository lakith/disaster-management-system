...
<?php
			...
			$sql = "SELECT place_name,lat,lng,heading,date,discription,disaster_management,special_note,warning_note,no_of_injuries,no_of_deaths,Damage_ammount FROM disaster_info WHERE heading='".$title."'";
