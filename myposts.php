...
<?php
	...
	$sql = "Select person_id from person Where username='$user'";
...
<html lang="en">
 ...
 <h2 class="text-center" style="margin-top: 2%;">My posts</h2>
	<br>
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-6">
		 ...
		 <?php
			$sql = "Select * FROM disaster_info WHERE person_informed ='$uid'";
			...
			<div class='card' style='margin-bottom: 2%;'>
  		 		<a href='view_disaster.php?id=".$row["id"]."' style='text-decoration: none'>
    					...
    					<div class='card-body'>
							...
							<div >
							 <a href='updatepost_user.php?id=".$row["id"]."' style='margin-top: 2%; float: right;margin-left: 1%; margin-right: 1%;' class='btn btn-dark'>Update</a>
							<a href='post_delete.php?id=".$row["id"]."' style='margin-top: 2%; float: right;margin-left: 1%; margin-right: 1%;' class='btn btn-dark'>Delete</a>
							</div>
						</div>
     				</a>
				</div>
