...
CREATE TABLE
		...
		(
			...
			CONSTRAINT 
				PK___Service_Provider_Mail2
			PRIMARY KEY
				(Service_provider_id,Email),

			CONSTRAINT 
				FK___Service_Provider___Service_Provider_Mail2
			FOREIGN KEY
				(Service_provider_id)
			REFERENCES
				Service_Provider(Service_provider_id)
...
ALTER TABLE Service_Provider_Mail
ADD CHECK (Email like '[a-zA-Z0-9]@[a-zA-Z0-9].[a-zA-Z0-9]');

INSERT INTO  Service_Provider_Mail Values ('001','lakith@gmail.com')
-------------------------------------------------------------------------------------------------------------------
