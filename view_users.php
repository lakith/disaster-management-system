...
function checklog(){
  ...
  <div class="container-fluid" style=" margin-top: 1%;" >
  	        <a class="weatherwidget-io" href="https://forecast7.com/en/6d9379d86/colombo/" data-label_1="COLOMBO" data-label_2="WEATHER" data-theme="original" >COLOMBO WEATHER</a>
<script>
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<center><h1 style="font-family: Baskerville, Palatino Linotype, Palatino, Century Schoolbook L, Times New Roman, serif">View All Users</h1></center><br>
				...
				<?php
			$sql = "Select * FROM person WHERE user_level =0";
					...
					while($row = $result->fetch_assoc()) {
						...
						echo "
							  <tr>
								...
								<td>".$row["username"]."</td>
								<td>".$row["Email"]."</td>
								<td><a href='delete_users.php?id=".$row["person_id"]." ' style='text-decoration: none; color: red'>Delete user</a></td>
							  </tr>
